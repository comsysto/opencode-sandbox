...
- Mounts your project root at the same full absolute path inside the container (e.g. `/home/user/my-project` is mounted at `/home/user/my-project`)
...
The `opencode-sandbox-config.yaml` file in your project root controls the project name, OpenCode HTTP port, outbound network access, and environment variables. It is safe to commit.
